    ...
    <div className="flex h-screen bg-base-200 text-base-content">
      ...
      >
        <div className="flex flex-col h-full overflow-y-auto">
          ...
          {/* Footer más compacto */}
          <div className="px-3 pb-3 pt-1.5 border-t border-base-200">
            <div className="flex items-center gap-2.5 p-2 rounded-lg bg-base-200 hover:bg-base-300/70 transition-colors">
              <div className="avatar">
                <div className="w-6 h-6 rounded-full bg-primary/20 text-primary flex items-center justify-center font-medium border border-primary/20 text-xs">
                  <span>A</span>
                </div>
              </div>
              <div>
