...
import { GenerarHorarioResponse } from '@/feactures/generar-horario/AsignacionHorarioService';
import BotonGenerarHorario from '@/feactures/generar-horario/components/BotonGenerarHorario';
...
export default function GenerarHorarioPage() {
  ...
  const handleHorarioGenerado = () => {
    // Este callback se ejecutará cuando el horario se genere exitosamente
            ...
            <div className="card-body">
              ...
              {!resultado && !error && (
                <div className="card-actions justify-end mt-6">
                  <BotonGenerarHorario
                    variant="primary"
                    className="btn-wide shadow-sm"
                    onHorarioGenerado={handleHorarioGenerado}
                  />
                </div>
              )}
            </div>
